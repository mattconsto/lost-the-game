...
public class Sprite {
    ...
    private static HashMap<TileAttr,Point> hashMap = new HashMap<TileAttr,Point>() {{
        ...
        put(TileAttr.POND, new Point(32*10,0));
        put(TileAttr.HUTONFIRE, new Point(32*11,0));
        put(TileAttr.WEB, new Point(32*12,0));
        put(TileAttr.WEBBED_TREE, new Point(32*13,0));
    }};
